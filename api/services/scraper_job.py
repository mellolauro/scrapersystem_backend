...
def run_scraper_job(payload: dict):
    ...
    Ele recebe o título e a lista de requisitos
    e retorna softwares + ranking baseado no score.
    """
    ...
    # 1. Buscar softwares no Google / web
    softwares = search_softwares(title)

    results = []

    # 2. Calcular score de aderência
    for s in softwares:
